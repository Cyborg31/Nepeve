...
class AcousticList extends StatefulWidget {
  @override
  AcousticListState createState() => AcousticListState();
}

class AcousticListState extends State<AcousticList> {
  ...
  geteventssnapshots() async {
    var data = await FirebaseFirestore.instance
        ...
        .where('category', isEqualTo: 'acoustic')
        .get();
